    ...
    <div class="row">
        <div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center mb-3">
            ...
            @if ($trip->current_status == 'Delivered')
                <div class="d-flex gap-3"><a href="{{ route('trips.index') }}"
                        class="btn btn-label-secondary">{{ __('Back') }}</a>
                </div>
            @endif
                ...
                <div class="bs-stepper wizard-icons wizard-icons-example mt-2">
                            ...
                            <div class="step" data-target="#route{{ $leg['country'] }}">
                                <button type="button" class="step-trigger">
                                    <span class="bs-stepper-icon">
                                        <img src="{{ asset('assets/img/flags/' . $leg['country'] . '.svg') }}"
                                            width="100" alt="">
                                    </span>
                                    <span
                                        class="bs-stepper-label">{{ __($leg['type']) . ' (' . __($leg['country']) . ')' }}</span>
                                </button>
                            </div>
                    ...
                    <div class="bs-stepper-content">
                        @foreach ($trip->tripRoute->legs as $key => $leg)
                            <form id="formSubmit{{ $leg['country'] }}" action="{{ route('trip-history.store') }}"
                                ...
                                <div id="route{{ $leg['country'] }}" class="content">
                                    ...
                                    <div class="row g-3">
                                                ...
                                                <div class="col-md mb-md-0 mb-3">
                                                    <div class="form-check custom-option custom-option-icon">
                                                        <label class="form-check-label custom-option-content"
                                                            ...
                                                            <input name="radio{{ $leg['country'] }}"
                                                                class="form-check-input" type="radio" value="At Warehouse"
                                                                data-current-country="{{ $leg['country'] }}"
                                                                data-current-route="{{ $key }}"
                                                                id="radioWarehouse{{ $leg['country'] }}" checked />
                                                        </label>
                                                    </div>
                                                </div>
                                                <div class="col-md mb-md-0 mb-3">
                                                    <div class="form-check custom-option custom-option-icon">
                                                        <label class="form-check-label custom-option-content"
                                                            ...
                                                            <span class="custom-option-body">
                                                                ...
                                                                @else
                                                                    <span
                                                                        class="custom-option-title">{{ __('Delivered') }}
                                                                    </span>
                                                                @endif
                                                            </span>
                                                            ...
                                                            @if ($leg['type'] != 'Destination')
                                                                <input name="radio{{ $leg['country'] }}"
                                                                    ...
                                                                    data-next-route="{{ $key }}"
                                                                    data-current-country="{{ $leg['country'] }}"
                                                                    type="radio" value="Enroute"
                                                                    id="radioEnroute{{ $leg['country'] }}" />
                                                            @else
                                                                <input name="radio{{ $leg['country'] }}"
                                                                    class="form-check-input"
                                                                    data-current-route="{{ $key }}"
                                        ...
                                        @if ($trip->tripHistory !== null && $trip->tripHistory !== false && count($trip->tripHistory) > 0)
                                        ...
                                        <div class="mb-3 col-12 mb-3">
                                            ...
                                            <input type="text" id="note" name="note{{ $leg['country'] }}"
                                                value="" class="form-control" placeholder="{{ __('Notes') }}" />
                                        </div>
                                        ...
                                        <div class="d-grid gap-2 col-md-2 col-sm-4 mx-auto">
                                            ...
                                            <button class="btn btn-primary btn-lg btn-next" id="btnConfirm"
                                                type="submit">
                                                <span
                                                    class="align-middle d-sm-inline-block d-none me-sm-1">{{ __('Confirm') }}</span>
                                            </button>
                                    ...
                                    <div class="timeline-event card p-0"
                                        ...
                                        <div
                                            ...
                                            <h6 class="card-title mb-0">
                                                {{ __($trip->tripRoute->legs[$history->route_leg]['type']) }}
                                            </h6>
                                            <div class="meta">
                                                @php
