...
<div id="wizard-checkout" class="bs-stepper wizard-icons wizard-icons-example mb-5">
  ...
  <div class="bs-stepper-content border-top">
    <form id="wizard-checkout-form" action="{{route('shipmentOnline.store')}}" method="POST" onsubmit="return false">
      <!-- Cart -->
                  ...
                  <div class="flex-grow-1">
                    <div class="row">
                      <div class="col-md-8">
                        ...
                        <div class="text-muted mb-2 d-flex flex-wrap"><span class="me-1">{{$item['category']}}:</span> <a href="javascript:void(0)" class="me-3">{{__('Category')}}</a> </div>
                        <!-- <div class="read-only-ratings mb-3" data-rateyo-read-only="true"></div> -->
                        <div class=" mb-2 d-flex flex-wrap"><span class="me-1">{{$item['quantity']}}:</span> <a href="javascript:void(0)" class="me-3">{{__('Quantity')}}</a> </div>
            ...
            <div class="border rounded p-4 mb-3 pb-3">
              ...
              <div class="row g-3 mb-3">
                <div class="col-8 col-xxl-8 col-xl-12">
                  <input type="text" name="couponCode" class="form-control" placeholder="{{__('Enter Coupon Code')}}" aria-label="Enter Coupon Code">
                </div>
                <div class="col-4 col-xxl-4 col-xl-12">
                  <div class="d-grid">
                    <button type="button" class="btn btn-label-primary" id="applyCoupon">{{__('Apply')}}</button>
                  </div>
                </div>
              </div>
              ...
              <dl class="row mb-0">
                ...
                <dd class="col-6 text-end">${{$totalItemsPrice}}</dd>

                <dt class="col-6 fw-normal text-heading">{{__('Delivery Charges')}}</dt>
                <dd class="col-6 text-end">
                  <span class="deliveryCost">${{$deliveryCharges}}</span>
              ...
              <dl class="row mb-0">
                ...
                <dd class="col-6 fw-medium text-end text-heading mb-0 totalAmount">${{$totalItemsPrice + $deliveryCharges}}</dd>
              </dl>
            </div>
            <div class="d-grid">
          ...
          <div class="col-xl-6 col-xxl-8 mb-3 mb-xl-0">
                ...
                <div class="form-check custom-option custom-option-basic checked">
                  <label class="form-check-label custom-option-content form-check-input-payment d-flex gap-3 align-items-center" for="cashRadio">
                    ...
                    <span class="custom-option-body d-flex align-items-center">
                      <img src="{{ asset('assets/img/backgrounds/cash_dollar.svg') }}" alt="cash" width="58">
            ...
            <div class="row py-4 my-2">
              ...
              <div class="col-md col-xl-5 mb-md-0 mb-2">
                <div class="form-check custom-option custom-option-basic checked">
                  <label class="form-check-label custom-option-content form-check-input-payment d-flex gap-3 align-items-center" for="toDoorRadio">
                    <input name="deliveryMethod" class="form-check-input" type="radio" value="toDoor" id="toDoorRadio" checked />
                    <span class="custom-option-body">
              ...
              <div class="col-md col-xl-5 mb-md-0 mb-2">
                <div class="form-check custom-option custom-option-basic">
                  <label class="form-check-label custom-option-content form-check-input-payment d-flex gap-3 align-items-center" for="pickupRadio">
                    <input name="deliveryMethod" class="form-check-input" type="radio" value="pickup" id="pickupRadio" />
                    <span class="custom-option-body">
            ...
            <div class="row my-2">
            <div class="col-12">
                      <button type="submit" class="btn btn-primary me-sm-3 me-1 waves-effect waves-light btn-submit">{{__('Submit')}}</button>
                      <button type="reset" class="btn btn-label-secondary waves-effect btn-prev">{{__('Back')}}</button>
                    </div>
            </div>
          ...
          <div class="col-xl-6 col-xxl-4">
            <div class="border rounded p-4">
              ...
              <dl class="row">
                ...
                <dd class="col-6 fw-medium text-end mb-0 totalAmount">${{$totalItemsPrice + $deliveryCharges}}</dd>

                <dt class="col-6 fw-normal text-heading">{{__('Deliver to')}}:</dt>
                <dd class="col-6 fw-medium text-end mb-0"><span class="badge bg-label-primary">{{__('Home')}}</span></dd>
              </dl>
              <!-- Address Details -->
