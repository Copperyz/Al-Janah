                        ...
                        <div class="col-md-6 mb-md-0 mb-3">
                            <div class="mb-3">
                                ...
                                <input class="form-control date-picker" id="datePicker" type="datetime-local"
                                    value="{{$shipment->orderDate}}" placeholder="{{__('Enter date')}}" name="date" />
                            </div>
                            <div class="mb-3">
                                <label for="salesperson" class="form-label me-4 fw-medium">{{__('Amount')}}</label>
                                <input type="text" class="form-control" id="salesperson"
                                    placeholder="{{__('Enter amount')}}" name="amount" value="{{$shipment->amount}}" />
                            </div>
                            <div class="mb-3">
                        ...
                        <div class="col-12">
                            <div class="mb-3">
                                ...
                                <textarea class="form-control" rows="2" id="notes" placeholder=""
                                    value="{{$shipment->notes}}" name="notes"></textarea>
                            </div>
                        </div>
                    </div>
                    <hr class="my-3 mx-n4" />
