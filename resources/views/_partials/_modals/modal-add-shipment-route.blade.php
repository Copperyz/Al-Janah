...
<div class="modal fade" id="addShipmentRouteModal" data-bs-backdrop="static" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-simple modal-add-new-address">
        <div class="modal-content p-3 p-md-5">
            <div class="modal-body">
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                <div class="text-center mb-4">
                    <h3 class="address-title mb-2">{{__('Add Shipment Route')}}</h3>
                    <p class="text-muted address-subtitle">{{__('Add defined legs for the route')}}</p>
                </div>
                <form class="form-repeater" id="addShipmentRouteForm" onsubmit="return false"
                    action="{{ route('shipments_routes.store') }}" method="POST">
                    ...
                    <div class="mb-3 col-12 mb-3">
                        <label class="form-label" for="form-repeater-1-3">{{__('Shipment Price')}}</label>
                        <input type="number" id="shipment_price" name="shipment_price" class="form-control"
                            placeholder="{{__('Shipment Price')}}" required />
                    </div>
