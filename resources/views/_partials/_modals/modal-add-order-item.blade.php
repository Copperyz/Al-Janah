<!-- Edit User Modal -->
<div class="modal fade" id="addOrderItemModal" data-bs-backdrop="static" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-simple modal-add-order-item">
        <div class="modal-content p-3 p-md-5">
            <div class="modal-body">
                ...
                <form id="addOrderItemForm" class="row g-3" onsubmit="return false">
