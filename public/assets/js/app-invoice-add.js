  ...
  if (sourceItem.length) {
    ...
    sourceItem.repeater({
      show: function () {
        ...
        console.log(counter)
        // Increment IDs for selects
        $(this).find('select[name="parcel_types_id"]').attr('id', 'parcel_types_id_' + counter);
        $(this).find('select[name="good_types_id"]').attr('id', 'good_types_id_' + counter);
