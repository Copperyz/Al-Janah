...
<div class="modal fade" id="addCurrencyModal" data-bs-backdrop="static" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-xl modal-simple modal-add-new-address">
        <div class="modal-content p-3 p-md-5">
            <div class="modal-body">
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                <div class="text-center mb-4">
                    <h3 class="address-title mb-2">{{ __('Add Currency') }}</h3>
                    <!-- <p class="text-muted address-subtitle">{{ __('Add defined legs for the route') }}</p> -->
                </div>
                <form id="addCurrencyForm" onsubmit="return false" action="{{ route('currencies.store') }}"
                    method="POST">
                    <div class="row">
