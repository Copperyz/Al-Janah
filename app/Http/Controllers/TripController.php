...
class TripController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('trips.index', compact('tripsCount', 'customersCount', 'deliveredCount', 'inProgressCount', 'tripRoutes'));
    }
    ...
    public function store(Request $request)
    {
        ...
        // Generate random unique delivery code
        $deliveryCode = Str::random(12);
        while (Trip::where('delivery_code', $deliveryCode)->exists()) {
            // Regenerate if the generated delivery code already exists
            $deliveryCode = Str::random(12);
        }
